  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(App, [{
    ...
    value: function _initFilter() {
      ...
      this._filter.on('filter', function (e) {
        _services_DataService_js__WEBPACK_IMPORTED_MODULE_8__["default"].getCurrencies({
          filter: e.detail
        }).then(function (data) {
          _this._data = data;

          _this._table.displayData(_this._data);
        });
      });
    }
  }, {
...
/*#__PURE__*/
function (_BaseComponent) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(Filter, _BaseComponent);
